...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="center" valign="top"><table width="90%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td align="left"><h1>Agenda</h1> Nuevo</td>
      </tr>
      <tr>
      	<td>&nbsp;</td>
      </tr>
      <tr>
      	<td align="left">
        <form action="estructura/agd.php?accion=crear" method="post" enctype="multipart/form-data" id="myForm">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
      	  <tr>
      	    <td align="right" class="label">Fecha<h4>(YYYY-MM-DD)</h4></td>
      	    <td align="left"><input name="fecha" type="text" class="campoNormal" id="fecha" /></td>
    	  </tr>
      	  <tr>
      	    <td align="right" class="label">Titulo</td>
      	    <td align="left"><input name="titulo" type="text" class="campoNormal" id="titulo" /></td>
    	  </tr>
      	  <tr>
      	    <td width="30%" align="right" class="label">Descripci&oacute;n</td>
      	    <td align="left"><textarea name="texto" rows="8" class="campoText" id="texto"></textarea></td>
    	  </tr>
      	  <tr>
      	    <td colspan="2">&nbsp;</td>
    	    </tr>
